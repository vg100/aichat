        ...
        <table class="table" id="data_table">
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td class="align-middle"><b><?php echo e($row->name); ?></b></td>
              <td class="align-middle"><?php echo e($row->direction); ?></td>
              <td class="align-middle"><?php echo e(Str::limit($row->word_json)); ?></td>
              ...
              <td class="align-middle">
                <div class="btn-group">
                  <a class="mr-1" href="<?php echo e(route('language.edit',$row->id)); ?>"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                <?php echo Form::open(['url' => 'dashboard/language/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<script type="text/javascript">
    ...
    $(".status").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(url('dashboard/language-status')); ?>",
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/owndev/public_html/copy-ai.testerdev.xyz/resources/views/language/index.blade.php ENDPATH**/ ?>