        ...
        <div class="card card-primary" style="width: 30% !important;">
            ...
            <div class="card-body">
                ...
                <form id="purchase_form">
                    ...
                    <div class="form-group">
                        <label for="purchase_code">keyCode: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="purchase_code" id="purchase_code" placeholder="Enter keyCode" autocomplete="off" required>
                    </div>
                ...
                <ul style="margin-left:-20px;">
                    <li><a target="_blank" href="https://google.com/licenses/standard">What The Licence Mean ?</a></li>
                    <li><a href="https://help.market.googles.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">Where Is My keyCode ?</a></li>
                    <li><a target="_blank" href="https://google.com/user/iqueen">Where I Can Bought a Licence ?</a></li>
                </ul> 
            </div>
        </div>
    </div>
...
</html><?php /**PATH /home4/khristian/copy-ai.surveysideadmin.com/resources/views/install/purchase_code.blade.php ENDPATH**/ ?>