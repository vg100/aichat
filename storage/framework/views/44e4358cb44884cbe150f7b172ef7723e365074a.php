...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/css/openai.css')); ?>">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand" style="z-index: 1;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <h3 class="text-2xl font-bold leading-7 sm:truncate ml-4"><?php echo $__env->yieldContent('title'); ?></h3>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="dropdown mt-1 mr-3">
          <a data-toggle="dropdown" href="#">
              <img class="rounded-circle" src="<?php if(Auth::user()->image): ?> <?php echo e(asset('uploads/'.Auth::user()->image)); ?> <?php else: ?> <?php echo e(asset('assets/images/no-user.jpg')); ?> <?php endif; ?>" width="40px" height="40px">
              <span class="badge badge-danger navbar-badge"></span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
              <?php if(Auth::user()->user_type == 'Super Admin' || Auth::user()->user_type == 'Demo'): ?><a class="dropdown-item" href="<?php echo e(url('admin/update-profile')); ?>">Profile</a><?php endif; ?>
  ...
  <aside class="main-sidebar bg-white" style="width:302px !important;border-right-width: 1px;">
    <!-- Brand Logo -->
    <a href="<?php echo e(url('admin/')); ?>" class="brand-link text-center" style="background-color: #2c2c2c;">
      <img src="<?php echo e(asset('uploads/'.App\Models\Setting::getSetting('white_logo'))); ?>" height="40px;">
    </a>
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-black" data-widget="treeview" role="menu" data-accordion="false">
            <li class="flex items-center">
                <a href="<?php echo e(url('admin/')); ?>" class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin') || Request::is('admin/user-profile') || Request::is('admin/package-detail*')): ?> active <?php endif; ?>">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/user*') && !Request::is('admin/user-profile') && !Request::is('admin/user-delete-request*')): ?> active <?php endif; ?>" href="<?php echo e(route('user.index')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/uses*') || Request::is('admin/today-generated-document') || Request::is('admin/today-generated-image')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/uses')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/plan*')): ?> active <?php endif; ?>" href="<?php echo e(route('plan.index')); ?>">
                    <span class="flex items-center">
            ...
            <!-- <li class="flex items-center">
                <a class="w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/coupon-code*')): ?> active <?php endif; ?>" href="<?php echo e(route('coupon-code.index')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/transaction*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/transaction')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/template*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/template')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/support-requests*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/support-requests')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/user-delete-request*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/user-delete-request')); ?>">
                    <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/inquiry*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/inquiry')); ?>">
                    <span class="flex items-center">
            ...
            <?php else: ?>
              ...
              <?php ($active=""); ?>
            <?php endif; ?>
            <li class="nav-item items-center has-treeview <?php echo e($class); ?>">
              <a href="#" class="text-light nav-link w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php echo e($active); ?>">
                <span class="flex items-center">
              ...
              <ul class="nav nav-treeview">
                <li class="flex items-center ml-3">
                  <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/blog-category*')): ?> active <?php endif; ?>" href="<?php echo e(route('blog-category.index')); ?>">
                      <span class="flex items-center">
                ...
                <li class="flex items-center ml-3">
                    <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/blog*') && !Request::is('admin/blog-category*')): ?> active <?php endif; ?>" href="<?php echo e(route('blog.index')); ?>">
                      <span class="flex items-center">
            ...
            <li class="flex items-center">
                <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium <?php if(Request::is('admin/setting*')): ?> active <?php endif; ?>" href="<?php echo e(url('admin/setting')); ?>">
                    <span class="flex items-center">
...
</html><?php /**PATH /home4/khristian/copy-ai.surveysideadmin.com/resources/views/layouts/master.blade.php ENDPATH**/ ?>