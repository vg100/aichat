        ...
        <table class="table" id="data_table">
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                 <?php if($row->user): ?>
                    <a href="<?php echo e(url('dashboard/user/'.$row->user->id)); ?>" style="font-size:15px;"><b><?php echo e($row->user->name); ?></b></a></td>
                 <?php else: ?>
                    <b>Deleted User</b>
                 <?php endif; ?>
              </td>
              ...
              <?php else: ?>
                ...
                <?php else: ?>
                <td><a class="btn btn-secondary" href="<?php echo e(url('dashboard/payment-completed/'.$row->id)); ?>" role="button">Completed</a></td>
                <?php endif; ?>
              <?php endif; ?>
              <td>
                <?php if($row->user): ?>
                    <a class="btn btn-primary" href="<?php echo e(url('dashboard/invoice-download/'.$row->payment_id)); ?>" role="button">Invoice</a>
                 <?php else: ?>
                    N/A
                 <?php endif; ?>
              ...
              <td>
                ...
                <?php echo Form::open(['url' => 'dashboard/transaction-delete','method'=>'POST','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/owndev/public_html/copy-ai.testerdev.xyz/resources/views/backend/transaction.blade.php ENDPATH**/ ?>