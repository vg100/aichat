        ...
        <table class="table" id="data_table">
          ...
          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><a href="<?php echo e(url('dashboard/user/'.$row->user->id)); ?>" style="font-size:15px;"><b><?php echo e($row->user->name); ?></b></a></td>
              ...
              <?php else: ?>
                ...
                <?php endif; ?>
              <?php endif; ?>
              <td><a class="btn btn-primary" href="<?php echo e(url('dashboard/invoice-download/'.$row->payment_id)); ?>" role="button">Invoice</a></td>
              <td>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ai_for_work\resources\views/backend/transaction.blade.php ENDPATH**/ ?>