                                ...
                                <div id="accordion" class="col-lg-10 col-md-9 col-sm-12 vertab-accordion panel-group"> 
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse1" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/app-setting','method'=>'POST','files'=>true]); ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-10 col-md-9">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-9" id="preview"><img type="image" class="shadow bg-white rounded" src="<?php if(App\Models\Setting::getSetting('black_logo')): ?><?php echo e(asset('uploads/'.App\Models\Setting::getSetting('black_logo'))); ?><?php else: ?><?php echo e(asset('assets/images/no-image.png')); ?><?php endif; ?>" alt="Image" style="width: auto;height: 70px" /></div>  
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-10 col-md-9">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-9" id="preview1"><img type="image" class="shadow bg-white rounded" src="<?php if(App\Models\Setting::getSetting('white_logo')): ?><?php echo e(asset('uploads/'.App\Models\Setting::getSetting('white_logo'))); ?><?php else: ?><?php echo e(asset('assets/images/no-image.png')); ?><?php endif; ?>" alt="Image"  style="width: auto;height: 70px" /></div>  
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-10 col-md-9">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-9" id="preview2"><img type="image" class="shadow bg-white rounded" src="<?php if(App\Models\Setting::getSetting('favicon')): ?><?php echo e(asset('uploads/'.App\Models\Setting::getSetting('favicon'))); ?><?php else: ?><?php echo e(asset('assets/images/no-image.png')); ?><?php endif; ?>" alt="Image" style="width: 50px;height: 50px" /></div>  
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse11" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/ads-setting','method'=>'POST','files'=>true]); ?>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse02" class="panel-collapse collapse">
                                            <div class="panel-body">
                                            <?php echo Form::open(['url' =>'admin/openai-setting','method'=>'POST','files'=>true]); ?>
                                            ...
                                            <?php echo Form::open(['url' =>'admin/add-openai-model','method'=>'POST','id'=>'model-form']); ?>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse55" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/payment-setting','method'=>'POST','files'=>true]); ?>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                            <?php echo Form::open(['url' =>'admin/email-setting','method'=>'POST','files'=>true]); ?>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse4" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/invoice-setting','method'=>'POST','files'=>true]); ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-10 col-md-9">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-9" id="preview3"><img type="image" class="shadow bg-white rounded" src="<?php if(App\Models\InvoiceSetting::getInvoiceSetting('invoice_logo')): ?><?php echo e(asset('uploads/'.App\Models\InvoiceSetting::getInvoiceSetting('invoice_logo'))); ?><?php else: ?><?php echo e(asset('assets/images/no-image.png')); ?><?php endif; ?>" alt="Image" style="width: 100px;height: 100px" /></div>  
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse8" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/app-update-setting','method'=>'POST','files'=>true]); ?>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse5" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <?php echo Form::open(['url' =>'admin/other-setting','method'=>'POST','files'=>true]); ?>
...
<script type="text/javascript">
    ...
    $(".addBtn").click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(url('admin/check-model-available')); ?>",
        data: {name : name},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp8_1\htdocs\copy_ai\resources\views/backend/setting.blade.php ENDPATH**/ ?>