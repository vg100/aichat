                                ...
                                <div id="accordion" class="col-lg-10 col-md-9 col-sm-12 vertab-accordion panel-group">
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse4" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/invoice-setting','method'=>'POST','files'=>true]) !!}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-6 col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-7" id="preview3"><img type="image" class="shadow bg-white rounded" src="@if(App\Models\InvoiceSetting::getInvoiceSetting('invoice_logo')){{asset('uploads/'.App\Models\InvoiceSetting::getInvoiceSetting('invoice_logo'))}}@else{{asset('assets/images/no-image.png')}}@endif" alt="Image" style="width: 100px;height: 100px" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse8" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/app-update-setting','method'=>'POST','files'=>true]) !!}
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse5" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/other-setting','method'=>'POST','files'=>true]) !!}
