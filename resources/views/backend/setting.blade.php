                                ...
                                <div id="accordion" class="col-12 vertab-accordion panel-group">
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse1" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/app-setting','method'=>'POST','files'=>true]) !!}
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-6 col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-8" id="preview"><img type="image" class="shadow bg-white rounded" src="@if(App\Models\Setting::getSetting('black_logo')){{asset('uploads/'.App\Models\Setting::getSetting('black_logo'))}}@else{{asset('assets/images/no-image.png')}}@endif" alt="Image" style="width: auto;height: 70px" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-6 col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-8" id="preview1"><img type="image" class="shadow bg-white rounded" src="@if(App\Models\Setting::getSetting('white_logo')){{asset('uploads/'.App\Models\Setting::getSetting('white_logo'))}}@else{{asset('assets/images/no-image.png')}}@endif" alt="Image"  style="width: auto;height: 70px" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-6 col-md-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-8" id="preview2"><img type="image" class="shadow bg-white rounded" src="@if(App\Models\Setting::getSetting('favicon')){{asset('uploads/'.App\Models\Setting::getSetting('favicon'))}}@else{{asset('assets/images/no-image.png')}}@endif" alt="Image" style="width: 50px;height: 50px" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse11" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/ads-setting','method'=>'POST','files'=>true]) !!}
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse02" class="panel-collapse collapse">
                                            <div class="panel-body">
                                            {!! Form::open(['url' =>'dashboard/openai-setting','method'=>'POST','files'=>true]) !!}
                                            ...
                                            {!! Form::open(['url' =>'dashboard/add-openai-model','method'=>'POST','id'=>'model-form']) !!}
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse55" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                {!! Form::open(['url' =>'dashboard/payment-setting','method'=>'POST','files'=>true]) !!}
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                            {!! Form::open(['url' =>'dashboard/email-setting','method'=>'POST','files'=>true]) !!}
                                    ...
                                    <div class="vertab-content">
                                        ...
                                        <div id="collapse2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                            {!! Form::open(['url' =>'dashboard/popup-setting','method'=>'POST','files'=>true]) !!}

                                            <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            {!! Form::label('popup_image','Popup Image', ['class' => 'col-xl-2 col-md-3 col-form-label']) !!}
                                                            <div class="col-xl-6 col-md-4">
                                                                <div class="row">
                                                                    <div class="col-xl-4"><input class="form-control" type="file" id="popup_image" name="name[popup_image]"></div>
                                                                    <div class="col-xl-8" id="preview4"><img type="image" class="shadow bg-white rounded" src="@if(App\Models\PopupSetting::getPopupSetting('popup_image')){{asset('uploads/'.App\Models\PopupSetting::getPopupSetting('popup_image'))}}@else{{asset('assets/images/no-image.png')}}@endif" alt="Image" style="width: 50px;height: 50px" /></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        {!! Form::label('link','Link', ['class' => 'col-xl-2 col-md-3 col-form-label']) !!}
                                                        <div class="col-xl-5 col-md-9">
                                                            {!! Form::text('name[link]',App\Models\PopupSetting::getPopupSetting('link'),['class' => 'form-control','required']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        {!! Form::label('button_text','Button Text', ['class' => 'col-xl-2 col-md-3 col-form-label']) !!}
                                                        <div class="col-xl-5 col-md-9">
                                                            {!! Form::text('name[button_text]',App\Models\PopupSetting::getPopupSetting('button_text'),['class' => 'form-control','required']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        {!! Form::label('enabled','Enabled', ['class' => 'col-xl-2 col-md-3 col-form-label']) !!}
                                                        <label class="cl-switch cl-switch-blue float-right">
                                                            <input type="checkbox" id="enabled" value="1" name="name[enabled]" @if(App\Models\PopupSetting::getPopupSetting('enabled')==1) checked @endif>
                                                            <span class="switcher"></span>
                                                        </label>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    ...
    $(".addBtn").click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "{{url('dashboard/check-model-available')}}",
        data: {name : name},
