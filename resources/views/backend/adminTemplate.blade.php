          ...
          @foreach($data as $row)
            <tr>
                ...
                <td class="align-middle">
                    <div class="btn-group">
                        <a href="{{url('dashboard/template/'.$row->id.'/edit-template') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                    </div>
                </td>
            </tr>
          @endforeach
...
<script type="text/javascript">
  ...
  $(".status").change(function(){
    ...
    $.ajax({
      type: "POST",
      url: "{{url('dashboard/template-status')}}",
