            ...
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group text-center">
                    <a href="{{url('dashboard/blog-category/'.$row->id.'/edit') }}" class="mr-1"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'dashboard/blog-category/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
...
<script type="text/javascript">
    ...
    $(".status").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "{{url('dashboard/blog-category-status')}}",
