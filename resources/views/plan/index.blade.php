  ...
  <div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <a href="{{ route('membership.create')}}" class="btn btn-success float-right">Add New</a>
        </div> 
        ...
        <table class="table" id="data_table">
          ...
          @foreach($data as $row)
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group">
                  <a class="mr-1" href="{{route('membership.edit',$row->id) }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'dashboard/membership/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
