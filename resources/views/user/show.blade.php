                                                ...
                                                <div class="d-flex">
                                                    <div class="me-4">
                                                        <p class="text-white text-sm opacity-8 mb-0">Words
                                                            Left</p>
                                                        <h6 class="text-white mb-0">{{$data->words_left}}</h6>
                                                    </div>
                                                    <div>
                                                        <p class="text-white text-sm opacity-8 mb-0">Images
                                                            Left</p>
                                                        <h6 class="text-white mb-0">{{$data->image_left}}</h6>
                                                    </div>
                                                </div>
                                                <div class="ms-auto d-flex align-items-end justify-content-end">
{{--                                                    <img class="w-60 mt-2" src="@if($data->image) @if(substr($data->image, 0, 4)=='http') {{$data->image}} @else {{asset('uploads/'.$data->image)}} @endif @else {{asset('assets/images/no-user.jpg')}} @endif" alt="logo">--}}
                                                    <span class="btn btn-primary rounded-pill" style="font-size:12px;"><i
                                                                class="fa-sharp fa-solid fa-crown text-yellow mr-2"></i><b>{{($data->subscription_id)?$data->plan->plan_name:"Trial Plan"}}</b></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                     style="background: linear-gradient(90deg, #1f93c4 0%, #2a3b8f 100%);">--}}
{{--                                    <div class="row">--}}
{{--                                        <div class="col-lg-6 col-md-6 col-sm-12">--}}
{{--                                            <div class="widget-user-image overflow-hidden mx-auto mt-3 mb-4">--}}
{{--                                                <img alt="User Avatar" class="rounded-circle mx-auto"--}}
{{--                                                     src="@if($data->image) @if(substr($data->image, 0, 4)=='http') {{$data->image}} @else {{asset('uploads/'.$data->image)}} @endif @else {{asset('assets/images/no-user.jpg')}} @endif"--}}
{{--                                                     height="80px" width="80px">--}}
{{--                                            </div>--}}
{{--                                            <h4 class="mb-2 mt-2 font-weight-800 text-light text-shadow">{{$data->name}}</h4>--}}
{{--                                            <h6 class="text-white text-shadow mb-3" style="font-size:12px;">--}}
{{--                                                <b>{{$data->email}}</b></h6>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-lg-6 col-md-6 col-sm-12 mt-4">--}}
{{--                                            <h4 class=" font-weight-800 text-light text-shadow"--}}
{{--                                                style="font-size:16px;">{{$data->words_left}}</h4>--}}
{{--                                            <h6 class="text-white mb-4 text-shadow" style="font-size:12px;"><b>Words--}}
{{--                                                    Left</b></h6>--}}

{{--                                            <h4 class=" font-weight-800 text-light text-shadow fs-16"--}}
{{--                                                style="font-size:16px;">{{$data->image_left}}</h4>--}}
{{--                                            <h6 class="text-white mb-4 text-shadow" style="font-size:12px;"><b>Images--}}
{{--                                                    Left</b></h6>--}}

{{--                                            <span class="btn btn-primary rounded-pill" style="font-size:12px;"><i--}}
{{--                                                        class="fa-sharp fa-solid fa-crown text-yellow mr-2"></i><b>{{($data->subscription_id)?$data->plan->plan_name:"Trial Plan"}}</b></span><br>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                                                ...
                                                <div class="col-8">
                                                    <div class="numbers">
                                                        ...
                                                        <h5 class="font-weight-bolder mb-0">
                                                            {{$documents_created}} <span style="font-size:18px;">contents</span>
                                                        </h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row vertab-container">
                                                ...
                                                <div class="row gx-4">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-xl position-relative">
                                                            <img src="@if($data->image) @if(substr($data->image, 0, 4)=='http') {{$data->image}} @else {{asset('uploads/'.$data->image)}} @endif @else {{asset('assets/images/no-user.jpg')}} @endif"
                                                                    ...
                                                                    <div class="list-group card card-body shadow-blur">
                                                                        <a href="#"
                                                                           class="list-group-item text-left"><img
                                                                                    ...
                                                                                    src="{{asset('assets/images/add_user_Icon/Edit profile_icon.svg')}}"
                                                                                    alt="Image"
                                                                        ...
                                                                        <a href="#"
                                                                           class="list-group-item text-left"><img
                                                                                    type="image" class="mr-2"
                                                                                    src="{{asset('assets/images/add_user_Icon/Transication.svg')}}"
                                                                                    alt="Image"
                                            ...
                                            <div id="accordion" class="col-12 vertab-accordion panel-group">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-xl-9 col-md-9">
                                                                            ...
                                                                            @if($data->image)
                                                                                <img src="@if(substr($data->image, 0, 4)=="http") {{$data->image}} @else {{asset('uploads/'.$data->image)}} @endif"
                                                ...
                                                <div id="collapse3" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        {!! Form::open(['url' => 'dashboard/subscription-update','method'=>'post','files'=>true]) !!}
                                                {!! Form::hidden('id',$data->id)!!}
                                                @if (count($errors) > 0)
                                                    <div class="alert alert-danger">
                                                        <ul>
...
@foreach($subscription as $sub)
                                                    <option value="{{$sub->id}}" @if($sub->id == $data->subscription_id)
                                                        selected
                                                    @endif>{{$sub->plan_name}}</option>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a onclick="exportWord(this);"
                                                                               ...
                                                                               data-value="{{$d->text}}"
                                                                               data-name="{{$d->name}}"><span
                                                                                        aria-hidden="true"
                                                                                        class="fa fa-download fa-xl mr-3 text-primary"></span></a>
                                                                            <a data-id="{{$d->id}}" data-toggle="modal"
                                                                               data-target="#documentModal"><span
                                                                                        aria-hidden="true"
                                                                                        class="fa fa-trash fa-xl text-primary"></span></a>
                                                                        </td>
                                                                        {!! Form::open(['url' => 'dashboard/document-delete','method'=>'POST','class'=>'form-horizontal','id'=>'docs_form_'.$d->id]) !!}
                                                                        {!! Form::hidden("id",$d->id) !!}
                                                                        {!! Form::close() !!}
                                                                    </tr>
                                                                @endforeach
                                                            ...
                                                            <table class="table table-bordered" id="image_table">
                                                                ...
                                                                @foreach($image as $img)
                                                                    <tr>
                                                                        <td>{{$img->id}}</td>
                                                                        <td>
                                                                            <img src="{{asset('uploads/aiImage/'.$img->image)}}"
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div style="display:inline-flex;">
                                                                                <span class="download text-primary"
                                                                                      ...
                                                                                      data-value="{{asset('uploads/aiImage/'.$img->image)}}"
                                                                        ...
                                                                        {!! Form::open(['url' => 'dashboard/ai-image-delete','method'=>'POST','class'=>'form-horizontal','id'=>'form_'.$img->id]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="my-auto col-sm-8">@if($data->subscription_id){{$data->plan->plan_name}}@else
                                                                Trial Plan @endif</sapn>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="my-auto col-sm-8">@if($data->subscription_start_date)
                                                                {{date('d M, y',strtotime($data->subscription_start_date))}}
                                                            @endif</sapn>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <span class="my-auto col-sm-8">@if($data->subscription_end_date)
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#plan").change(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{url('dashboard/user-get-plan')}}",
                    data: {id: value},
