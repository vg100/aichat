                                        ...
                                        <tr>
                                            <td>
                                                <div class="notification"><img
                                                            src="@if($row->image) @if(substr($row->image, 0, 4)=='http') {{$row->image}} @else {{asset('uploads/'.$row->image)}} @endif @else {{asset('assets/images/no-user.jpg')}} @endif"
                                                            class="rounded-circle"
                                                            @if($row->is_subscribe) style="border: 3px solid red;"
                                                            @endif alt="Image" width="40" height="40"/></div>
                                                <a href="{{url('dashboard/user/'.$row->id) }}" class="ml-md-3"
                                                   style="font-size:15px;"><b>{{$row->name}}</b></a></td>
                                            ...
                                            <td class="align-middle">
                                                <div class="btn-group">
                                                    <a href="{{url('dashboard/user/'.$row->id) }}" class="mr-1">
                                                        <button type="button" class="btn btn-warning"><span
                                                                    aria-hidden="true" class="fa fa-eye"></span>
                                                        </button>
                                                    </a>
                                                    @if($row->user_type != "Super Admin")
                                                        <a data-id="{{$row->id}}" data-toggle="modal"
                                                ...
                                                {!! Form::open(['url' => 'dashboard/user/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
            ...
            <div id="changepass" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {!! Form::open(['url'=>url('dashboard/change_password'),'id'=>'changepass_form']) !!}
                            <form id="change" action="{{url('dashboard/change_password')}}" method="POST">
