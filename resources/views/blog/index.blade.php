            ...
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group text-center">
                    <a href="{{url('dashboard/blog/'.$row->id.'/edit') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'dashboard/blog/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
