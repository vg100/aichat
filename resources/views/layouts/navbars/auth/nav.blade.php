    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
            ...
            <li class="nav-item d-flex align-items-center">
                ...
                @if(Auth::user()->user_type == 'Super Admin' || Auth::user()->user_type == 'Demo')<a class="dropdown-item" href="{{url('dashboard/admin-profile ')}}">Profile<img style="margin-left:10px;" class="rounded-circle" src="@if(Auth::user()->image) {{ asset('uploads/'.Auth::user()->image) }} @else {{ asset('assets/images/no-user.jpg') }} @endif" width="40px" height="40px"></a>@endif
