...
<div class="wrapper">
            ...
            <li class="dropdown mt-1 mr-3">
                <a data-toggle="dropdown" href="#">
                    <img class="rounded-circle"
                         src="@if(Auth::user()->image) {{ asset('uploads/'.Auth::user()->image) }} @else {{ asset('assets/images/no-user.jpg') }} @endif"
                         width="40px" height="40px">
                    <span class="badge badge-danger navbar-badge"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    @if(Auth::user()->user_type == 'Super Admin' || Auth::user()->user_type == 'Demo')
                        <a class="dropdown-item" href="{{url('dashboard/admin-profile ')}}">Profile</a>
                    @endif
    ...
    <aside class="main-sidebar bg-white" style="width:302px !important;border-right-width: 1px;">
        <!-- Brand Logo -->
        <a href="{{ url('dashboard/')}}" class="brand-link text-center" style="background-color: #2c2c2c;">
        ...
        <div class="sidebar" style="padding-bottom:40px;background-color: #2c2c2c;">
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column text-black" data-widget="treeview" role="menu"
                    data-accordion="false">
                    <li class="flex items-center">
                        <a href="{{ url('dashboard/')}}"
                           class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('admin') || Request::is('dashboard/user-profile') || Request::is('dashboard/package-detail*')) active @endif">
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/user*') && !Request::is('dashboard/user-profile') && !Request::is('dashboard/delete-user-request*')) active @endif"
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/uses*') || Request::is('dashboard/today-generated-document') || Request::is('dashboard/today-generated-image')) active @endif"
                           href="{{url('dashboard/uses')}}">
                    <span class="flex items-center">
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/plan*')) active @endif"
                    ...
                    <!-- <li class="flex items-center">
                <a class="w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/coupon-code*'))
                        active
                    @endif" href="{{route('coupon-code.index')}}">
                    <span class="flex items-center">
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/transaction*')) active @endif"
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/template*')) active @endif"
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/support-requests*')) active @endif"
                           href="{{url('dashboard/support-requests')}}">
                    <span class="flex items-center">
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/delete-user-request*')) active @endif"
                           href="{{ url('dashboard/delete-user-request')}}">
                    <span class="flex items-center">
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/contact-list*')) active @endif"
              ...
              <ul class="nav nav-treeview">
                <li class="flex items-center ml-3">
                  <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/blog-category*'))
                        active
                ...
                <li class="flex items-center ml-3">
                    <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/blog*') && !Request::is('dashboard/blog-category*'))
                        active
                    ...
                    <li class="flex items-center">
                        <a class="text-light w-full rounded-md hover:bg-gray-50 group flex items-center justify-between p-3 text-gray-600 hover:text-gray-800 font-medium @if(Request::is('dashboard/setting*')) active @endif"
