        ...
        <table class="table" id="data_table">
          ...
          @foreach($data as $row)
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group">
                  <a href="{{url('dashboard/coupon-code/'.$row->id.'/edit') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'dashboard/coupon-code/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
...
<script type="text/javascript">
    ...
    $(".status").change(function(){
      ...
      $.ajax({
        type: "POST",
        url: "{{url('dashboard/coupon-code-status')}}",
